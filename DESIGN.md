...
The hero rack, role transitions, primary résumé action and mobile reading sequence are unchanged. The generated Impeccable `design.json` sidecar remains untouched.
