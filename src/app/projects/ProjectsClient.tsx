    ...
    useEffect(() => {
        async function fetchProjects() {
            try {
                ...
                if (data) {
                    // Map DB snake_case columns to camelCase if needed, OR relies on Supabase auto-mapping if configured? 
                    // Supabase JS returns data as is in DB columns usually (snake_case).
                    ...
                    const mappedProjects: Project[] = data.map((p: any) => ({
                        ...
                        // details, metrics, colors, links are jsonb so they return as objects, which matches.
                    }));
