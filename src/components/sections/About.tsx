        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <p className="text-gray-300 leading-relaxed text-lg">
              I&apos;m a <span className="text-blue-400 font-semibold">Systems Engineer</span> specializing in <span className="text-purple-400 font-semibold">AI-powered infrastructure automation</span>. 
              With a passion for building high-performance, secure, and scalable systems, my expertise spans cloud 
              architecture, LLM integration, network automation, and enterprise security compliance.
            </p>
            <p className="text-gray-300 leading-relaxed text-lg">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-300">
                  ...
                  <span>lorenztazan@gmail.com</span>
                </div>
                <div className="flex items-center gap-3 text-gray-300">
                  <Phone className="w-5 h-5 text-emerald-400" />
                  <span>240-256-2410</span>
                </div>
                <div className="flex items-center gap-3 text-gray-300">
                  <MapPin className="w-5 h-5 text-purple-400" />
                  <span>Remote (Open to On-site)</span>
                </div>
                <div className="flex items-center gap-3 text-gray-300">
